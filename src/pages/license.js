            ...
            <div>
                <div>
                    <h1>Legal Information</h1>
                        <p>Permission to copy, modify and distribute the files collectively known as 
                            the System Reference Document 5.1 (“SRD5”) is granted solely through 
                            the use of the Open Gaming License, Version 1.0a. This material is being released 
                            using the Open Gaming License Version 1.0a and you should read and understand 
                            the terms of that license before using this material.</p>
                        <p>The text of the Open Gaming License itself is not Open Game Content. 
                            ...
                            the conditions set forth in Section 7 of the OGL, and are not Open Content:</p>
                        <p>Dungeons & Dragons, D&D, Player’s Handbook, Dungeon Master, Monster Manual, 
                            d20 System, Wizards of the Coast, d20 (when used as a trademark), Forgotten Realms, 
                            Faerûn, proper names (including those used in the names of spells or items), places, 
                            Underdark, Red Wizard of Thay, the City of Union, Heroic Domains of Ysgard, 
                            EverChanging Chaos of Limbo, Windswept Depths of Pandemonium, 
                            ...
                            Seven Mounting Heavens of Celestia, Twin Paradises of Bytopia, Blessed Fields of Elysium, 
                            Wilderness of the Beastlands, Olympian Glades of Arborea, 
                            ...
                            displacer beast, githyanki, githzerai, mind flayer, illithid, umber hulk, yuan-ti.</p>
                        <p>
                            All of the rest of the SRD5 is Open Game Content as described in Section 1(d) of 
                            the License. The terms of the Open Gaming License Version 1.0a are as follows: 
                ...
                <div>
                    <div>
                        <h3>1.	Definitions:</h3>
                        <p>(a)"Contributors"	means	the	
                            copyright	and/or	trademark	owners	who	have	
                            contributed	Open	Game	Content;</p>
                        <p>(b)"Derivative	
                            ...
                            transformed	or	adapted;</p>
                        <p>(c)	"Distribute"	means	to	
                            reproduce,	license,	rent,	lease,	sell,	broadcast,	
                            publicly	display,	transmit	or	otherwise	distribute;	</p>
                        <p>(d)"Open	Game	Content"	means	the	game	mechanic	
                            ...
                            Identity.	</p>
                        <p>(e)	"Product	Identity"	means	product	and	
                        ...
                        <p>(f)	"Trademark"	means	the	
                            ...
                            the	Open	Game	License	by	the	Contributor</p>
                        <p>(g)	"Use",	
                            "Used"	or	"Using"	means	to	use,	Distribute,	copy,	edit,	
                            format,	modify,	translate	and	otherwise	create	
                            Derivative	Material	of	Open	Game	Content.</p>
                        <p>(h)	"You"	Not	for	resale.	Permission	granted	to	print	or	photocopy	this	document	for	personal	use	only. System	Reference	Document	5.1 2
                            or	"Your" means	the	licensee	in	terms	of	this	
                            agreement.</p>
                    </div>
                    <div>
                        <h3>2.	The	License:</h3>
                        <p>This	License	applies	to	any	Open	
                    ...
                    <div>
                        <h3>3.Offer	and	Acceptance:</h3>
                        <p>By	Using	the	Open	Game	
                            Content	You	indicate	Your	acceptance	of	the	terms	of	
                            this	License.	</p>
                    </div>
                    <div>
                        <h3>4.	Grant	and	Consideration:</h3>
                        <p>	In	consideration	for	
                            ...
                            to	Use,	the	Open	Game	Content.	</p>
                    </div>
                    <div>
                        <h3>5.Representation	of	Authority	to	Contribute:</h3>
                        <p>If	You	
                    ...
                    <div>
                        <h3>6.Notice	of	License	Copyright:</h3>
                        <p>You	must	update	the	
                            ...
                            Content	you	Distribute.	</p>
                    </div>
                    <div>
                        <h3>7.	Use	of	Product	Identity:</h3>
                        <p>You	agree	not	to	Use	any	
                            ...
                            in	and	to	that	Product	Identity.	</p>
                    </div>
                    <div>
                        <h3>8.	Identification:</h3>
                        <p>If	you	distribute	Open	Game	
                            Content	You	must	clearly	indicate	which	portions	of	
                            the	work	that	you	are	distributing	are	Open	Game	
                            Content.</p>
                    </div>
                    <div>
                        <h3>9.	Updating	the	License:</h3>
                        <p>Wizards	or	its	designated	
                    ...
                    <div>
                        <h3>10.	Copy	of	this	License:</h3>
                        <p>You	MUST	include	a	copy	of	
                            this	License	with	every	copy	of	the	Open	Game	
                            Content	You	Distribute.</p>
                    </div>
                    <div>
                        <h3>11.	Use	of	Contributor	Credits:</h3>
                        <p>You	may	not	market	
                    ...
                    <div>
                        <h3>12.	Inability	to	Comply:</h3>
                        <p>If	it	is	impossible	for	You	to	
                    ...
                    <div>
                        <h3>14.	Reformation:</h3>
                        <p>If	any	provision	of	this	License	is	
                            held	to	be	unenforceable,	such	provision	shall	be	
                            reformed	only	to	the	extent	necessary	to	make	it	
                            enforceable.</p>
                    </div>
                    <div>
                        <h3>15.	COPYRIGHT	NOTICE</h3>
                        <p>Open	Game	License	v	1.0a	Copyright	2000,	Wizards	
                            of	the	Coast,	LLC.</p>
                    </div>
                    <div>
                        <p>System	Reference	Document	5.1 Copyright	2016,	
                            ...
                            original	material	by	E.	Gary	Gygax	and	Dave	Arneson.</p>
                    </div>
                    <h1>END	OF	LICENSE</h1>
                </div>
            </div>
        )
    }
